...
<!--
  IMAGE 1 (hero): a screenshot of your desktop with several widgets on it
  (e.g. Weather + Music Player + Calendar + CPU/RAM/Battery).
  Save it as docs/images/hero.png
-->
![Project Nexus widgets on the desktop](docs/images/hero.png)

---

## Overview

Project Nexus is a collection of small, good-looking widgets that sit on top of your Windows desktop and show useful information at a glance: the weather, what's playing, the time around the world, system load, and more.
...
<!--
  IMAGE 2 (gallery): one image showing all widgets side by side.
  Save it as docs/images/widgets.png
-->
![All widgets](docs/images/widgets.png)
...
<!--
  IMAGE 3 (theming): the same widgets in two different color schemes, side by side.
  Save it as docs/images/theming.png
-->
![Same widgets, two color themes](docs/images/theming.png)
...
Released under the **[LICENSE NAME]** license. See `LICENSE` for details.

---

<sub>Built by [YOUR NAME](https://github.com/YOUR-USERNAME)</sub>
